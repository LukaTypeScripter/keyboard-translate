          ...
          <Fragment key={index}>
            <section className="flex justify-between items-center">
              ...
              <figure className="col-span-2/3 row-span-full">
                <audio
                  ref={audioRef}
                  src={`https://api.dictionaryapi.dev/media/pronunciations/en/${data.word}-us.mp3`}
                ></audio>
              ...
              <section key={index}>
                ...
                <ul className="list-none list-custom-purple mt-4 pl-4">
                  {meaning.definitions.map((definition, index) => (
                    <li key={index} className="relative pl-6 py-1">
                ...
                <div>
                  {meaning.synonyms.length > 0 && (
                    <div>
                      <h4 className="mt-6 pt-6 border-t border-[#3b3b3b] text-gray-500 text-lg">
                        Synonyms
                      </h4>
