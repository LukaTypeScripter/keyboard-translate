      ...
      <div className="flex justify-between gap-[1.625rem] items-center ">
        ...
        "
          >
            ...
            <img src={iconArrowDown} alt="" className="w-[14px] h-[8px]" onClick={() => setShowSmallModal(!showSmallModal)}/>
          </div>
          {/**TODO:PopUp Modal */}
          {showSmallModal && (
